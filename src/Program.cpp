...
Program::var_uniform_type_to_name_table_t Program::m_var_uniform_type_to_name_table[] = {
        ...
        {Program::var_uniform_type_inv_normal_xform,                "inv_normal_xform"},
        {Program::var_uniform_type_inv_projection_xform,            "inv_projection_xform"},
        {Program::var_uniform_type_inv_view_proj_xform,             "inv_view_proj_xform"},
        ...
        {Program::var_uniform_type_model_xform,                     "model_xform"},
        {Program::var_uniform_type_mvp_xform,                       "mvp_xform"},
        {Program::var_uniform_type_normal_xform,                    "normal_xform"},
        ...
        {Program::var_uniform_type_view_proj_xform,                 "view_proj_xform"},
