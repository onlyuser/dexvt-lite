...
int init_resources()
{
    ...
    ik_hrail->set_ik_joint_type(vt::XformObject::IK_JOINT_TYPE_PRISMATIC);
    ...
    ik_vrail->set_ik_joint_type(vt::XformObject::IK_JOINT_TYPE_PRISMATIC);
    ...
    ik_base->set_ik_joint_type(vt::XformObject::IK_JOINT_TYPE_PRISMATIC);
