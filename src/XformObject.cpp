    ...
    float        accept_distance)
{
    for(int i = 0; i < iters; i++) {
            ...
            current_segment = current_segment->get_parent())
        {
            ...
            glm::vec3 new_current_segment_heading      = glm::vec3(GLM_ROTATE(glm::mat4(1), -angle_delta, local_pivot) * glm::vec4(current_segment_heading, 1));
            glm::vec3 new_current_segment_up_direction = glm::vec3(GLM_ROTATE(glm::mat4(1), -angle_delta, local_pivot) * glm::vec4(current_segment_up_direction, 1));
