...
void onTick()
{
    ...
    //meshes[0]->rotate(1, glm::vec3(0, 1, 1)); // sign flip -- reaches 90 degrees vertical and enters undefined state!
    //meshes[0]->rotate(1, glm::vec3(1, 0, 1)); // no sign flip
    //meshes[0]->rotate(1, glm::vec3(1, 1, 0)); // no sign flip
