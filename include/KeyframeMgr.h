...
public:
    ...
    void lerp_frame_value(int frame_number, glm::vec3* value, bool is_smooth = false) const;
...
public:
    ...
    void lerp_frame_value_for_motion_track(MotionTrack::motion_type_t motion_type, int frame_number, glm::vec3* value, bool is_smooth = false) const;
...
public:
    ...
    bool lerp_frame_value_for_object(long object_id, int frame_number, glm::vec3* origin, glm::vec3* orient, glm::vec3* scale, bool is_smooth = false) const;

    // util
    bool get_frame_number_range(long object_id, int* start_frame_number, int* end_frame_number) const;
    void generate_control_points(float control_point_scale);
    bool export_object_frame_values(long object_id, std::vector<glm::vec3>* origin_frame_values, std::vector<glm::vec3>* orient_frame_values, bool is_smooth = false) const;
