...
public:
    ...
    static Mesh* create_sphere(std::string name = "",
                               int         slices = DEFAULT_SLICES,
                               int         stacks = DEFAULT_STACKS,
                               float       radius = 1);
    static Mesh* create_hemisphere(std::string name   = "",
                                   int         slices = DEFAULT_SLICES,
                                   int         stacks = DEFAULT_STACKS,
                                   float       radius = 1);
    static Mesh* create_cylinder(std::string name   = "",
                                 int         slices = DEFAULT_SLICES,
                                 float       radius = 1,
                                 float       height = 1);
    static Mesh* create_cone(std::string name   = "",
                             int         slices = DEFAULT_SLICES,
                             float       radius = 1,
                             float       height = 1);
    static Mesh* create_torus(std::string name         = "",
                              int         slices       = DEFAULT_SLICES,
                              int         stacks       = DEFAULT_STACKS,
                              float       radius_major = 1,
                              float       radius_minor = 0.5);
    static Mesh* create_box(std::string name   = "",
                            float       width  = 1,
                            float       height = 1,
                            float       length = 1);
    static Mesh* create_tetrahedron(std::string name   = "",
                                    float       width  = 1,
                                    float       height = 1,
                                    float       length = 1);
    static Mesh* create_geosphere(std::string name               = "",
                                  float       radius             = 1,
                                  int         tessellation_iters = 3);
    static Mesh* create_diamond_brilliant_cut(std::string name,
                                              float       radius                                     = 0.5,
