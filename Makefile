...
CPP_STEMS_IK        = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject Light Modifiers main_ik        Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_BOIDS     = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject Light Modifiers main_boids     Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_HEXAPOD   = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject Light Modifiers main_hexapod   Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_DELTABOT  = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject Light Modifiers main_deltabot  Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_3DPRINTER = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject Light Modifiers main_3dprinter Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_TERRAIN   = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject Light Modifiers main_terrain   Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_SPIDER    = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject Light Modifiers main_spider    Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_FREEROT   = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject Light Modifiers main_freerot   Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_RAIL      = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject Light Modifiers main_rail      Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_STEWART   = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject Light Modifiers main_stewart   Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
