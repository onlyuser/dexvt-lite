...
BUILD_PATH = build
BIN_PATH = bin
BIN_STEMS = main_ik main_boids main_hexapod main_deltabot main_3dprinter main_terrain main_spider main_freerot main_rail main_stewart
...
.PHONY : clean_objects
clean_objects :
	-rm $(OBJECTS_IK) $(OBJECTS_BOIDS) $(OBJECTS_HEXAPOD) $(OBJECTS_DELTABOT) $(OBJECTS_3DPRINTER) $(OBJECTS_3DPRINTER) $(OBJECTS_TERRAIN) $(OBJECTS_SPIDER) $(OBJECTS_FREEROT) $(OBJECTS_RAIL) $(OBJECTS_STEWART)

#==================
# binaries
#==================

CPP_STEMS_IK        = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject KeyframeMgr Light Modifiers main_ik        Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_BOIDS     = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject KeyframeMgr Light Modifiers main_boids     Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_HEXAPOD   = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject KeyframeMgr Light Modifiers main_hexapod   Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_DELTABOT  = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject KeyframeMgr Light Modifiers main_deltabot  Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_3DPRINTER = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject KeyframeMgr Light Modifiers main_3dprinter Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_TERRAIN   = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject KeyframeMgr Light Modifiers main_terrain   Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_SPIDER    = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject KeyframeMgr Light Modifiers main_spider    Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_FREEROT   = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject KeyframeMgr Light Modifiers main_freerot   Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_RAIL      = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject KeyframeMgr Light Modifiers main_rail      Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
CPP_STEMS_STEWART   = BBoxObject Buffer Camera File3ds FrameBuffer IdentObject KeyframeMgr Light Modifiers main_stewart   Material Mesh NamedObject OctTree PrimitiveFactory Program Scene Shader ShaderContext shader_utils Texture Util VarAttribute VarUniform TransformObject
